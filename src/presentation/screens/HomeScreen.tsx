...
const TIPS = [
  { icon: '🔋', title: 'Batería', desc: 'No enciende tu auto' },
  { icon: '🔧', title: 'Motor', desc: 'Ruidos extraños' },
  { icon: '🛞', title: 'Llanta', desc: 'Pinchazo en ruta' },
  { icon: '⚡', title: 'Eléctrico', desc: 'Fallas eléctricas' },
];
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        >
          ...
          <View style={styles.statsRow}>
            <View style={styles.stat}>
              <Text style={styles.statValue}>{user.totalServices}</Text>
        ...
        <View style={styles.sosSection}>
          <Text style={styles.sectionTitle}>¿Necesitas ayuda ahora?</Text>
          <Text style={styles.sectionSubtitle}>
            Presiona SOS y encontraremos un mecánico disponible cerca tuyo
          </Text>
